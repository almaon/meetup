...
public class UserCreatedEvent_to_Meetings implements IEventHandler<UserCreatedEvent> {
	...
	private com.example.meetup.meetings.application.integration.listen.userCreated.UserCreatedMeetingsIntegrationEvent mapToIntegrationEvent(com.example.meetup.userAccess.domain.users.events.UserCreatedEvent sourceEvent) {
		
		var targetInstance = new com.example.meetup.meetings.application.integration.listen.userCreated
				.UserCreatedMeetingsIntegrationEvent();
		...
		targetInstance.setUserType(com.example.meetup.meetings.application.integration.listen.userCreated
