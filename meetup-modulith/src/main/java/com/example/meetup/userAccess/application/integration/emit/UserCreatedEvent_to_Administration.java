...
public class UserCreatedEvent_to_Administration implements IEventHandler<UserCreatedEvent> {
	...
	private com.example.meetup.administration.application.integration.listen.userCreated.UserCreatedAdministrationIntegrationEvent mapToIntegrationEvent(com.example.meetup.userAccess.domain.users.events.UserCreatedEvent sourceEvent) {
		
		var targetInstance = new com.example.meetup.administration.application.integration.listen.userCreated
				.UserCreatedAdministrationIntegrationEvent();
		...
		targetInstance.setUserType(com.example.meetup.administration.application.integration.listen.userCreated
